    ...
    <SwapContainer>
        ...
        <TokenOneContainer>
            ...
            <EContainer style={{display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center'}}>
                ...
                <Text style={{color: '#4A3CE8'}}>{(maxarbQVE/10**18).toFixed(2)} mQVE</Text>
                </EContainer>
            </EContainer>
        </TokenOneContainer>
        ...
        <EContainer style={{display: 'flex',flexDirection: 'row', justifyContent: 'space-between',  alignItems:'center'}}>
            ...
            <EContainer style={{display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center'}}>
                ...
                <Text style={{color: '#5C5E81'}}>Available</Text>
                <EContainer style={{width: '4px'}}></EContainer>
                <Text style={{color: '#4A3CE8'}}>{(maxarbQVE/10**18).toFixed(2)} QVE</Text>
                </EContainer>
            </EContainer>
        </TokenTwoContainer>
        <EContainer style={{height: '20px'}}></EContainer>
        <EContainer style={{width: '100%', display: 'flex', justifyContent: 'flex-start'}}>
        <Text style={{fontWeight: '400', fontSize: '11px', lineHeight: '13px', paddingLeft:'10px', color: '#B7B8CD'}}>1 mQVE ≈ {(AtoB/10**18).toFixed(2)} QVE</Text>
        </EContainer>
        <EContainer style={{height: '20px'}}></EContainer>
