  ...
  return (
    <Background>
      <EContainer style={{ maxWidth: "374px" }}>
        ...
        <Text style={{ fontFamily: "Montserrat", fontStyle: "normal" }}>
          Fund Liquidation
        </Text>
        <Text style={{ fontFamily: "Montserrat", fontStyle: "normal" }}>
          Solution
        ...
        >
          <Button onClick={MainPage} style={{ width: "200px", height: "60px" }}>
            Invest Now
          </Button>
        </EContainer>
      </EContainer>
      ...
      >
        ...
        <ThreeContainer>
          ...
          <Text
            style={{ fontWeight: "700", fontSize: "16px", lineHeight: "19px" }}
          >
            $123,456
          </Text>
        </ThreeContainer>
      ...
      <EContainer style={{ height: "50px" }}></EContainer>
      <Button style={{ height: "60px", width: "200px" }} onClick={MainPage}>
        Deposit Coins
      </Button>
