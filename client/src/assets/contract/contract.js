...
const ArbQVEContract = new web3.eth.Contract(
  ArbQVEArtifact.output.abi,
  Address.ArbQVEAddress
);
const QVEContract = new web3.eth.Contract(
  QVEArtifact.output.abi,
  Address.QVEAddress
);
const UsdtContract = new web3.eth.Contract(
  UsdtArtifact.output.abi,
  Address.UsdtAddress
);
const DepositContract = new web3.eth.Contract(
  DepositArtifact.output.abi,
  Address.DepositAddress
);
const LiquidityContract = new web3.eth.Contract(
  LiquidityArtifact.output.abi,
  Address.LiquidityAddress
);
const StakeContract = new web3.eth.Contract(
  StakeArtifact.output.abi,
